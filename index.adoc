...
- `<$hand>`
 * Will display your item in chat, including the tooltip

- `<$pos/position>`
 * Will display `[position]` in chat, which will let users see more information by hovering over it with their cursor.
====
