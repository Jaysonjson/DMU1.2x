...
* `MANAGE_ROLES` - Defines whether users with the role can set another members role, alongside update permissions for it

* `ASSIGN_ROLES` - Defines whether users with the role can change a members role

* `ASSIGN_CAPES` - Defines whether users with the role can give members access to any capes the faction may have
...
* `MANAGE_ROLES` - Defines whether users with the role can create other roles, and manage their permissions

* `ASSIGN_ROLES` - Defines whether users with the role can give members town roles

* `ASSIGN_CAPES` - Defines whether users with the role can give a player access to any capes the town may have

* `KICK_MEMBERS` - Defines whether users with the role can remove players from the town

* `ACCEPT_JOIN_REQUESTS` - Defines whether users with the role can accept a users request to join the town
